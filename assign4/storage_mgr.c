...
//printf("\n inside openPageFile");
//printf("\n inside openPageFile - fileName = <%s>",fileName);
  filePointer = fopen(fileName, "w+"); //Open the file named fileName in read module
  //printf("\n filePointer = <%d>",filePointer);
  if(filePointer == NULL){
  	//printf("\n inside openPageFile - filePointer is null");
    //RC_message = "Unable to open the file as file is not found";
    result = RC_FILE_NOT_FOUND;
  }
  else
  {
  //	 printf("\n inside openPageFile - inside else ");
  	  //   printf("\n#############################");
    fHandle->fileName = fileName;
  //  printf("\n inside openPageFile - fHandle->fileName = <%s>",fHandle->fileName);
  //      printf("\n#############################");
    fseek(filePointer, 0, SEEK_END); //fseek points the file pointer to the end of the file
   // printf("\n inside openPageFile - after fseek");
  //  printf("\n#############################");
  //  printf("\n#############################");
...
/*if (pageNum > fHandle->totalNumPages || pageNum < 0)
{
	...
	printf("\n INSIDE writeBlock - pageNum > fHandle->totalNumPages");
        	return RC_WRITE_FAILED;
        }*/
printf("\n----------------------------------------");
        printf("\n ---- fHandle->fileName = <%s>",fHandle->fileName);
        printf("\n----------------------------------------");
	...
	if(filePointer == NULL)
	{
		printf("\n INSIDE writeBlock - filePointer = null");
